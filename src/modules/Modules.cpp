...
#endif
// Generated by bin/optional-modules.py from whatever sits in src/modules/optional/. Absent from a
// stock checkout, and empty unless a module has been dropped in.
#if __has_include("OptionalModules.h")
