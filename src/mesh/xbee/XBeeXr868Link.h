...
class XBeeXr868Link
{
  public:
    ...
    uint8_t sendAtCommand(char command0, char command1, const uint8_t *value = nullptr, size_t valueLength = 0);
  ...
  private:
    ...
    size_t writeFrame(const uint8_t *frame, size_t frameLength);
